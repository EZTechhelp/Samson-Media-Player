...
## Important Notes/Requirements for Testers <a name="Important_Notes_Requirements"></a>
...
- Also includes code to allow scrolling while dragging an item when using dragdrop, and some other tidbits
...
- Used to route per app audio sessions for capture via [VB-Cable](https://vb-audio.com/Cable/) and output which enables features such as EQ support for webplayers
...
**Installer/EXE - BETA - TESTERS ONLY<a name="Inno_Setup_Installer"></a>**  
...
**Powershell Script - BETA - TESTERS ONLY** <a name="Powershell_Script"></a>
